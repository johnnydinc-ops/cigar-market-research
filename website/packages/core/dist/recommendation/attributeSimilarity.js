...
exports.attributeSimilarityScore = attributeSimilarityScore;
exports.attributeBaselineRecommendations = attributeBaselineRecommendations;
/** Strength/body difference: 0 = same, 1 = max spread (4 steps). */
function scaleDistance(a, b) {
    if (a == null || b == null)
        return 0.5;
 ...
 */
function attributeSimilarityScore(seed, candidate) {
 ...
 */
function attributeBaselineRecommendations(seed, catalog, options = {}) {
...
//# sourceMappingURL=attributeSimilarity.js.map