...
function defaultTos(sourceId, sourceName, domain) {
    return {
        sourceId,
        sourceName,
...
function retailerIdFromSourceId(sourceId) {
...
export function createFamousSmokeConnector(tosMetadata, options) {
...
function extractCigarsInternationalListing(html) {
    return extractListingProductsGeneric(html, CIGARS_INTERNATIONAL.baseUrl, {
        productPathPattern: /\/p\//,
        linkSelector: 'a[href*="/p/"]',
    });
}
export function createCigarsInternationalConnector(tosMetadata, options) {
...
export function createJRCigarsConnector(tosMetadata, options) {
...
function extractThompsonListing(html) {
    return extractListingProductsGeneric(html, THOMPSON_CIGAR.baseUrl, {
        productPathPattern: /\/p\//,
        linkSelector: 'a[href*="/p/"]',
    });
}
export function createThompsonCigarConnector(tosMetadata, options) {
...
export function createHoltsConnector(tosMetadata, options) {
...
export function createGothamCigarsConnector(tosMetadata, options) {
...
export function createMikesCigarsConnector(tosMetadata, options) {
...
export function createSmokeInnConnector(tosMetadata, options) {
...
export const RETAILER_CONNECTOR_ENTRIES = [
